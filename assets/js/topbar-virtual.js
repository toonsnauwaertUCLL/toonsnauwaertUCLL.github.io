        ...
        if( direction === 'down' && !$(this.element).hasClass('ftco-animated') ) {
          ...
          $('.number').each(function(){
            var $this = $(this),
              ...
              var customNumberStep = function(now, tween) {
                var formattedNumber = Math.round(now); // Round the number to the nearest integer
                if (formattedNumber >= 200) {
